  ...
  return (
    <div className="h-screen flex items-center justify-between p-8">
      ...
      <div className="w-full lg:w-1/2 flex flex-col gap-4">
        ...
        <SignUp.Root>
          {/* Paso 1 */}
          <SignUp.Step className="flex flex-col gap-4" name="start">
            ...
            {/* Registrarse con credenciales */}
            <div className="flex flex-col gap-4">
              Registrarse con credenciales
              <Clerk.Field name="username" className="flex flex-col gap-2">
                <Clerk.Input className="py-2 px-6 rounded-full text-black w-72 placeholder:text-sm bg-white" placeholder="Nombre de usuario" />
                <Clerk.FieldError className="text-red-300 text-sm" />
              </Clerk.Field>

              <Clerk.Field name="emailAddress" className="flex flex-col gap-2">
                <Clerk.Input className="py-2 px-6 rounded-full text-black w-72 placeholder:text-sm bg-white" placeholder="Correo electrónico" />
                <Clerk.FieldError className="text-red-300 text-sm" />
              </Clerk.Field>
              ...
              <SignUp.Captcha />
              <SignUp.Action className="bg-iconBlue rounded-full p-2 text-white font-bold w-72 text-center cursor-pointer" submit>Registrar</SignUp.Action>
            </div>
          </SignUp.Step>

          {/* Paso 2 */}
          <SignUp.Step className="flex flex-col gap-4" name="continue">
            <Clerk.Field name="username">
              <Clerk.Input className="py-2 px-6 rounded-full text-black w-72 placeholder:text-sm bg-white" placeholder="Nombre de usuario" />
              <Clerk.FieldError className="text-red-300 text-sm" />
            </Clerk.Field>

            <SignUp.Action className="w-72 text-center text-iconBlue underline" submit>Continuar</SignUp.Action>
          </SignUp.Step>

          {/* Paso 3 */}
          <SignUp.Step name="verifications">
            <SignUp.Strategy name="email_code">
              <h1 className="text-sm mb-2">Revisa tu correo electrónico</h1>
              <Clerk.Field className="flex flex-col gap-4" name="code">
                <Clerk.Input
              ...
              <SignUp.Action className="mt-2 underline text-iconBlue text-sm" submit>Verificar</SignUp.Action>
            </SignUp.Strategy>
          </SignUp.Step>
